// englret.cpp
// возвращениефункцией значени€ типа Distance
...
public:
	...
	{ }
	Distance (int ft,float in): feet(ft),inches(in)	// конструктор с 
	{ }								// двум€ аргументами
...
Distance Distance::add_dist(Distance d2)
{
	...
	{									// то уменьшаем еЄ на 12.0
		temp.inches -= 12.0;			// и увеличиваем число 
		temp.feet = 1;					// футов на 1
	}
